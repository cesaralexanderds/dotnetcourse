...
public static class EmailService{
    ...
    public static void SendMail(){
        ...
        message.From.Add(new MailboxAddress("Cesar Alexander", "locus430@gmail.com"));
        message.To.Add (new MailboxAddress ("Admin", "cesar.alexanderds@gmail.com"));
        ...
        using (var client = new SmtpClient()){
            ...
            client.Authenticate("locus430@gmail.com", "wmbr mkml rpjj hlju ");
            client.Send(message);
